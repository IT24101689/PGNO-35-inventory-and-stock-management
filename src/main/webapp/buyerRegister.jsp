...
<head>
    ...
    <title>Buyer Registration - Inventory Management System</title>
    <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;500;700&family=Poppins:wght@300;500;700&display=swap"
          rel="stylesheet">
...
<div class="container">
    <div class="hero">
        ...
        <h2>Create a New Buyer Account</h2>
    </div>
    ...
    <form action="buyerRegister" method="post">
        ...
        <div class="input-group">
            ...
            <input type="password" id="confirm-supplier-password" name="confirmPassword" required
    ...
    <div class="footer">
        <p>Already have an account? <a href="buyerLogin.jsp">Login</a></p>
    </div>
</div>
