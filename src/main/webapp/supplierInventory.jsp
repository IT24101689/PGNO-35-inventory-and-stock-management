...
<head>
    ...
    <title>Supplier Inventory - Inventory Management</title>
...
<div class="container">
    ...
    <p>Manage your supplied inventory items here. You can view, add, and remove items as needed.</p>

    <a href="addStock.jsp" class="button">Add Item</a>
    <a href="removeSupplierItem.jsp" class="button">Remove Item</a>
